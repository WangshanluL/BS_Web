...
const animationUrl ="https://lottie.host/795835c7-a672-4f0d-8684-6827602d232f/fAjOCWsTXs.json"
...
<template>
  <v-container>
    ...
    <div class="d-flex justify-space-between align-start">
      ...
      <v-row>
        <v-col cols="12" md="5" lg="4" style="margin-top: 47px;">
          <v-file-input
            v-model="files"
        ...
        <v-col cols="12" md="7" lg="8">
          ...
          <div class="card">
              ...
              <div v-if="showshow" style="margin-top: 50px;"><Vue3Lottie 
:animationLink="animationUrl"
:height="400"
:width="400"

/>                   <h4 class="text-h8 text-md-h4 text-primary" style="display: flex; justify-content: center; align-items: center; margin: 0 auto;">
    等待输出
</h4>
</div>
