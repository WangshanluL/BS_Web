<template>
  <div class="comment-item" v-if="commentData.pCommentId==0">
    ...
    <div class="comment-info">
      ...
      <div class="comment-content">
        ...
        <CommentImage
          ...
          :src="
            proxy.globalInfo.commentImage + commentData.imgPath
          "
          :imgList="[proxy.globalInfo.commentImage + commentData.imgPath]" ></CommentImage>
      </div>
...
const doLike = async (data) => {
  try {
    let response = await axios.post(proxy.globalInfo.url_f+'/comment/doLike', {
      commentId: data.commentId,
      userId: "your_user_id_here", // 你需要替换成实际的用户ID
    });
